...
(function (factory) {
    ...
    Rating.prototype = {
        ...
        _parseAttr: function (vattr, options) {
            var self = this, $el = self.$element, elType = $el.attr('type'), final__, val, chk;
            if (elType === 'range' || elType === 'number') {
                ...
                final__ = isEmpty(val) ? chk : val;
                return parseFloat(final__);
            }
        ...
        init: function (options) {
            ...
            if (self.$rating === undefined && self.$container === undefined) {
                self.$rating = $(document.createElement("div")).html('<div class="rating-stars jcx-rating"></div>');
        ...
        generateRating: function () {
            var self = this, clear = self.renderClear(), caption = self.renderCaption(),
                ...
                stars = self.getStars();
            if (self.glyphicon) {
                css += (self.symbol === '\ue006' ? ' rating-gly-star jcx-rating' : ' rating-gly') + self.ratingClass;
            } else {
    ...
    $.fn.rating.defaults = {
        ...
        showCaption: true,
        starCaptionClasses: {
            0.5: 'starlabel starlabel-danger',
            1: 'starlabel starlabel-danger',
            1.5: 'starlabel starlabel-warning',
            2: 'starlabel starlabel-warning',
            2.5: 'starlabel starlabel-info',
            3: 'starlabel labstarlabelel-info',
            3.5: 'starlabel starlabel-primary',
            4: 'starlabel starlabel-primary',
            4.5: 'starlabel starlabel-success',
            5: 'starlabel starlabel-success'
        },
