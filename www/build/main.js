...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jcx_api_service__ = __webpack_require__(198);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_setting_service__ = __webpack_require__(278);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_8__app_component__["a" /* JcxApp */], {}, {
                    links: []
                }),
...
var JcxApp = /** @class */ (function () {
    ...
    JcxApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\1_ionic\ws3.0\jcx\src\app\app.html"*/'\n\n<ion-menu [content]="content">\n\n  <ion-header>\n\n    <ion-toolbar>\n\n      <div class="sidebar-logo"></div>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n\n\n  <ion-content>\n\n      <ion-list>\n\n        <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)" style="color: #387ef5;">\n\n          <ion-icon name="{{p.icon}}"></ion-icon>&nbsp;&nbsp;{{p.title}}\n\n        </button>\n\n  \n\n        <button class="item-block item item-md" menuToggle  style="color: #387ef5;">\n\n          <ion-icon name="close"></ion-icon>\n\n        </button>\n\n      </ion-list>\n\n    </ion-content>\n\n\n\n</ion-menu>\n\n\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\1_ionic\ws3.0\jcx\src\app\app.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_storage__ = __webpack_require__(195);
...
var JcxLitePage = /** @class */ (function () {
    ...
    */
    ...
    JcxLitePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-jcx-lite',template:/*ion-inline-start:"C:\1_ionic\ws3.0\jcx\src\pages\jcx-lite\jcx-lite.html"*/'<ion-header>\n\n\n\n    <ion-navbar>\n\n      <ion-buttons start>\n\n        <button menuToggle>\n\n          <ion-icon large name="menu"></ion-icon>\n\n        </button>\n\n      </ion-buttons>\n\n      <div class="topbar-logo"></div>\n\n      <ion-buttons end>\n\n        <button (click)="myMoreAction($event)">\n\n          <ion-icon large name="add"></ion-icon>\n\n        </button>\n\n      </ion-buttons>\n\n    </ion-navbar>\n\n  \n\n  </ion-header>\n\n  \n\n  \n\n  <ion-content>\n\n  \n\n    <h4 style="text-align: center; font-weight: 800;">集诚信 -- 独立第三方电商评价体系</h4>\n\n  \n\n  <ion-list>\n\n    <ion-item>\n\n      <ion-textarea placeholder="粘贴宝贝在手淘里的分享代码或者宝贝的网址或者店铺的网址……"></ion-textarea>\n\n    </ion-item>\n\n    <ion-item>\n\n      <button class="" (click)="searchShops()" style="width: 100%; background-color: transparent; height: 35px;\n\n              border: 1px solid #ccc; border-radius: 4px; padding: 6px;"><i class="fa fa-search"></i>\n\n          <strong style="color: #f90;">搜店铺</strong>\n\n      </button>      \n\n    </ion-item>\n\n    <ion-item></ion-item>\n\n    <ion-item>      \n\n      <button class="" (click)="searchShops()" style="width: 100%; background-color: transparent;\n\n              border: 1px solid #ccc; border-radius: 4px; padding: 6px;">\n\n              <ion-icon name="camera">扫一扫</ion-icon>\n\n      </button>\n\n    </ion-item>    \n\n  </ion-list>\n\n  \n\n  </ion-content>'/*ion-inline-end:"C:\1_ionic\ws3.0\jcx\src\pages\jcx-lite\jcx-lite.html"*/
        }),
...
var TradePostsListPage = /** @class */ (function () {
    ...
    TradePostsListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-trade-posts-list',template:/*ion-inline-start:"C:\1_ionic\ws3.0\jcx\src\pages\jcx-trade\trade-posts-list\trade-posts-list.html"*/'<!--\n\n  Generated template for the PostsList page.\n\n\n\n  See http://ionicframework.com/docs/v2/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>{{topic.title}}</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content>\n\n\n\n  <div padding *ngIf="topicPage != null && topicPage.totalPages > 1">\n\n    <ion-segment>\n\n      <ion-segment-button *ngIf="topicPage.thisPage > 1" value="prePage" (ionSelect)="previousPage(topicPage.thisPage, topicPage.recordsPerPage)">\n\n        上一页\n\n      </ion-segment-button>\n\n      <ion-segment-button value="thisPage">\n\n        {{topicPage.thisPage}}/{{topicPage.totalPages}}\n\n      </ion-segment-button>\n\n      <ion-segment-button *ngIf=" topicPage.totalPages > topicPage.thisPage" value="nextPage" (ionSelect)="nextPage(topicPage.thisPage, topicPage.recordsPerPage)">\n\n        下一页\n\n      </ion-segment-button>\n\n    </ion-segment>\n\n  </div>\n\n\n\n  <div *ngIf="topicPage != null && topicPage.posts != null">\n\n    <ion-list>\n\n      <ion-item *ngFor="let post of topicPage.posts">\n\n        <div class="postText" [innerHTML]=" post.longtext | safeHtml"></div>\n\n      </ion-item>\n\n    </ion-list>\n\n  </div>\n\n\n\n  <div padding *ngIf="topicPage != null && topicPage.totalPages > 1">\n\n    <ion-segment>\n\n      <ion-segment-button *ngIf="topicPage.thisPage > 1" value="prePage" (ionSelect)="previousPage(topicPage.thisPage, topicPage.recordsPerPage)">\n\n        上一页\n\n      </ion-segment-button>\n\n      <ion-segment-button value="thisPage">\n\n        {{topicPage.thisPage}}/{{topicPage.totalPages}}\n\n      </ion-segment-button>\n\n      <ion-segment-button *ngIf=" topicPage.totalPages > topicPage.thisPage" value="nextPage" (ionSelect)="nextPage(topicPage.thisPage, topicPage.recordsPerPage)">\n\n        下一页\n\n      </ion-segment-button>\n\n    </ion-segment>\n\n  </div>\n\n\n\n  <div [ngStyle]="{\'display\': nicEditorDisplay}" padding>\n\n    <label class="labelField">回复: </label>\n\n    <div class="niceDiv">\n\n      <textarea class="subjectTextarea" style="width: 100%; height: 200px;" id="niceTradeTextArea"></textarea>\n\n    </div>\n\n    <button ion-button full (click)="sendNewTradeReply()" >发送</button>\n\n  </div>\n\n</ion-content>'/*ion-inline-end:"C:\1_ionic\ws3.0\jcx\src\pages\jcx-trade\trade-posts-list\trade-posts-list.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__shared_shared__["b" /* UserSettings */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__shared_shared__["a" /* JcxApi */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* LoadingController */]])
...
var JcxZbarPage = /** @class */ (function () {
    function JcxZbarPage(navCtrl, zbar) {
        this.navCtrl = navCtrl;
        this.zbar = zbar;
    }
    ...
    */
    JcxZbarPage.prototype.scan = function () {
        ...
        this.zbar.scan(zBarOptions).then(function (data) {
            console.log(data);
            _this.results = data;
        }, function (err) {
            // An error occurred
    ...
    JcxZbarPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-jcx-zbar',template:/*ion-inline-start:"C:\1_ionic\ws3.0\jcx\src\pages\jcx-native\jcx-zbar\jcx-zbar.html"*/'<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>扫描二维码</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <button ion-button full color="primary" (click)="scan()" >扫描</button>\n\n  <button ion-button full color="secondary" (click)="reset()" style="margin-top: 30px;">重置</button>\n\n\n\n  <div *ngIf="results">\n\n    <h2>文本：{{results}}</h2>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\1_ionic\ws3.0\jcx\src\pages\jcx-native\jcx-zbar\jcx-zbar.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_zbar__["a" /* ZBar */]])
    ], JcxZbarPage);
    return JcxZbarPage;
}());
...
var SbIneedCommentPage = /** @class */ (function () {
    ...
    SbIneedCommentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sb-ineed-comment',template:/*ion-inline-start:"C:\1_ionic\ws3.0\jcx\src\pages\sidebar\sb-ineed-comment\sb-ineed-comment.html"*/'<!--\n\n  Generated template for the SbIneedComment page.\n\n\n\n  See http://ionicframework.com/docs/v2/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>我要评价</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n<p>你好，这里是INeedComment页面。</p>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\1_ionic\ws3.0\jcx\src\pages\sidebar\sb-ineed-comment\sb-ineed-comment.html"*/
        }),
...
var SbBrowseShopPage = /** @class */ (function () {
    ...
    SbBrowseShopPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sb-browse-shop',template:/*ion-inline-start:"C:\1_ionic\ws3.0\jcx\src\pages\sidebar\sb-browse-shop\sb-browse-shop.html"*/'<!--\n\n  Generated template for the SbBrowseShop page.\n\n\n\n  See http://ionicframework.com/docs/v2/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>浏览分类网店</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n<p>你好，这里是Browse页面。</p>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\1_ionic\ws3.0\jcx\src\pages\sidebar\sb-browse-shop\sb-browse-shop.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */]])
    ], SbBrowseShopPage);
...
var SbRankListPage = /** @class */ (function () {
    ...
    SbRankListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sb-rank-list',template:/*ion-inline-start:"C:\1_ionic\ws3.0\jcx\src\pages\sidebar\sb-rank-list\sb-rank-list.html"*/'<!--\n\n  Generated template for the SbRankList page.\n\n\n\n  See http://ionicframework.com/docs/v2/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>排行榜/指数</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n<p>你好，这里是Rank页面。</p>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\1_ionic\ws3.0\jcx\src\pages\sidebar\sb-rank-list\sb-rank-list.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */]])
    ], SbRankListPage);
